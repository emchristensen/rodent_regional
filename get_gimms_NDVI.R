...
################################################
#Extract the NDVI time series for Portal
...
###############################
# download the data -- this downloads data for the whole world (only option as far as I can tell)
# version 1 is the default: 1981-2015. Version 0 consists of smaller files but only goes to 2013
downloadGimms(x=as.Date('2011-01-01'),
              y=as.Date('2016-01-01'),
              dsn='C:/Users/echriste/Desktop/GIMMS')

portal_ndvi = get_gimms_ndvi(gimms_folder = 'C:/Users/echriste/Desktop/GIMMS')
